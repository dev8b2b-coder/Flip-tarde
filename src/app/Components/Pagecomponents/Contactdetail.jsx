      ...
      <div className="inn_container py-16 md:py-24 lg:py-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 max-w-[1380px] gap-5 xl:gap-0 m-auto pt-10 md:pt-16 lg:pt-20">
          {contactdetail.map(data =>
            <div
              key={data.id}
              className={`flex flex-col items-center max-w-[400px] w-full m-auto gap-2 px-[4px] lg:gap-4 2xl:gap-5 py-[20px] md:py-[24px] lg:py-[36px] [clip-path:polygon(0_0,80%_0,100%_20%,100%_100%,20%_100%,0_80%)] rounded-2xl ${data.id === 2 ? ' bg-primary shadow-[inset_1px_0px_20px_20px_#462A9C]' :'bg-subprimary shadow-[inset_1px_0px_20px_20px_#ffffff5e]'}`}
            >
