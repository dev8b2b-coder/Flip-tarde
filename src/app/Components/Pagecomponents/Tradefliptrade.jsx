        ...
        <div className="relative hidden xl:block">
          ...
          <div className="absolute top-[4%] 2xl:top-[2%] left-[25%] w-max">
            ...
            <div className="relative w-max">
              ...
              />
              <p className="absolute top-4 right-4 list_text font-light font_ternary  max-w-[400px]  text-center md:text-end lg:max-w-[unset] md:text-[unset] leading-6 xl:leading-[28px]">
                Copy trades instantly with real <br /> time execution.
              </p>
            </div>
          </div>
          <div className="absolute top-[18%] left-[5%] w-max">
            <h5 className="pe-16 text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl lg:leading-[35px]  font-medium text-primary text-end">
              Verified Traders
            </h5>
            <div className="relative w-max">
              <Image
              ...
              />
              <p className="absolute top-4 right-16 list_text font-light font_ternary  max-w-[400px]  text-center md:text-end lg:max-w-[unset] md:text-[unset] leading-6 xl:leading-[28px]">
                Follow trusted and high-performing <br /> strategy providers.
              </p>
            </div>
          </div>
          <div className="absolute bottom-[50%] left-[2%] w-max">
            <h5 className="pe-16 2xl:pe-24 text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl lg:leading-[35px]  font-medium text-primary text-end">
              Transparent Results
            </h5>
            <div className="relative w-max">
              <Image
                ...
                className="max-w-[410px] 2xl:max-w-[560px]"
              />
              <p className="absolute top-4 right-16 2xl:right-24 list_text font-light font_ternary  max-w-[400px]  text-center md:text-end lg:max-w-[unset] md:text-[unset] leading-6 xl:leading-[28px]">
          ...
          <div className="absolute bottom-[35%] left-[5%] w-max">
            <h5 className="pe-44 2xl:pe-40 text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl lg:leading-[35px]  font-medium text-primary text-end">
              Full Control
            </h5>
            <div className="relative w-max">
              <Image
                ...
                className="max-w-[410px] 2xl:max-w-[560px]"
              />
              <p className="absolute top-4 right-44 2xl:right-40 list_text font-light font_ternary  max-w-[400px]  text-center md:text-end lg:max-w-[unset] md:text-[unset] leading-6 xl:leading-[28px]">
                Adjust, pause, or stop <br /> copying anytime.
              </p>
            </div>
          </div>
          <div className="absolute top-[4%] right-[6%] w-max">
            <h5 className="ps-4 text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl lg:leading-[35px]  font-medium text-primary text-start">
            ...
            <div className="relative w-max">
              <Image
                ...
                className="max-w-[350px] 2xl:max-w-[448px]"
              />
              <p className="absolute top-4 left-4 list_text font-light font_ternary  max-w-[400px]  text-center md:text-start lg:max-w-[unset] md:text-[unset] leading-6 xl:leading-[28px]">
                Set amounts and risk levels that <br /> suit your strategy.
              </p>
            </div>
          </div>
          <div className="absolute bottom-[25%] right-[12%] w-max">
            <h5 className="ps-18 2xl:ps-32 text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl lg:leading-[35px]  font-medium text-primary text-start">
              Community Learning
            </h5>
            <div className="relative w-max">
              <Image
                ...
                className="max-w-[410px] 2xl:max-w-[560px]"
              />
              <p className="absolute top-4 left-32 list_text font-light font_ternary  max-w-[400px]  text-center md:text-start lg:max-w-[unset] md:text-[unset] leading-6 xl:leading-[28px]">
                Adjust, pause, or stop <br /> copying anytime.
              </p>
            </div>
          </div>
